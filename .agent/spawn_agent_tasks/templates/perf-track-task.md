...
```json
{
  ...
  "baselineMeasurements": [
    { "metric": "[metric]", "value": "[value]", "budget": "[budget]", "status": "PASS|WARN|FAIL" }
  ],
  "bottleneckFindings": [
    { "id": 1, "bottleneck": "[bottleneck]", "metricImpact": "[impact]", "location": "file/component", "confidence": "[1-10]" }
  ],
  "optimizationRecommendations": [
    { "id": 1, "optimization": "[what to do]", "expectedImprovement": "[improvement]", "effort": "Low|Med|High", "risk": "Low|Med|High", "quickWin": true }
  ],
  "selfAssessment": {
    "measurementConfidence": "[1-10]",
    "prematureOptimizationRisk": "Low|Med|High",
    "regressionRisk": "Low|Med|High"
  },
  "limitations": "[What was NOT profiled, environmental caveats]"
}
```
