...
1. **File Ownership Map:** Assign every file that will be touched to exactly one agent (`anti-patterns-swarm.md` §7.1). No two agents may write to the same file in parallel.
